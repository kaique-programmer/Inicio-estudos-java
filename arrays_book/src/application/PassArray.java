...
public class PassArray {
    // main create array and call modifyArray and modifyElement
    public static void main(String[] args) {
        int[] array = {1,2,3,4,5};
        System.out.printf("Effects of passing reference to entire array:%n" +
                            "The values of the original array are:%n");

        // generates output element of the original array
        for(int value: array)
            System.out.printf(" %d", value);

        modifyArray(array); // pass a reference of the array
        System.out.printf("%n%nThe values of the modified array are:%n");

        // generates output element of the array modified
        for(int value : array)
            System.out.printf("  %d", value);
        ...
        modifyElement(array[3]); // try modify the array[3]
